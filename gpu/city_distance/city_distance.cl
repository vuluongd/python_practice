// OpenCL kernel to calculate pairwise distances between cities given their coordinates
...
__kernel void city_distance(int size, __global float* x, __global float* y, __global float *final){
